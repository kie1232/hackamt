...
class App:
    def __init__(self, master):
        ...
        self.selecao_frame.pack(padx=20, pady=20, fill="both", expand=True)
    ...
    def criar_home(self):
        ...
        self.imagem = Image.open("C:/Users/Igoor/OneDrive/Documentos/Projetos/hackamt/in.png")  # Ajuste o caminho aqui
        self.imagem = self.imagem.resize((400, 300))  # Remove o ANTIALIAS
        self.imagem_tk = ImageTk.PhotoImage(self.imagem)

        self.imagem_label = tk.Label(self.home_frame, image=self.imagem_tk)
    ...
    def abrir_id_frame(self, event):
        ...
        # Carregar os IDs já registrados
        for id_value in self.progresso[produto_selecionado]:
            print(f"ID já registrado: {id_value}")  # Aqui você pode fazer o que quiser com os IDs
